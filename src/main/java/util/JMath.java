...
public class JMath {
    ...
    public static void rotateInDegrees(Vector2f vec, float angleDeg, Vector2f origin) {
    ...
    public static void rotateInRadians(Vector2f vec, float angleRad, Vector2f origin) {
        float x = vec.x - origin.x;
        float y = vec.y - origin.y;
